 ...
 * @author HP
 */
public class tecNotice extends javax.swing.JFrame {

    /**
     * Creates new form TecNotice
     */
    public tecNotice() {
        initComponents();
        showData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tecNotice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
