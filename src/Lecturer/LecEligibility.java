...
public class LecEligibility {
    ...
    {
        try {
         String q = "select count(stu_id) from attendances where stu_id='"+id+"' and sub_id='"+sub+"' and type='T' and status='1'";
	...
	try {
        String q = "select count(stu_id) from attendances where stu_id='"+id+"' and sub_id='"+sub+"' and type='P' and status='1'";
        PreparedStatement ps = con.prepareStatement(q);
        ResultSet rs = ps.executeQuery(q);
    ...
    int getMedicalTheory(String id,String sub){
        try {
            ...
            String q = "select count(stu_id) from medicals  where stu_id='"+id+"' and sub_id='"+sub+"' and type='T'";
            PreparedStatement ps = con.prepareStatement(q);
            ResultSet rs = ps.executeQuery(q);
	...
	try {
            ...
            String q = "select count(stu_id) from medicals  where stu_id='"+id+"' and sub_id='"+sub+"' and type='P'";
            PreparedStatement ps = con.prepareStatement(q);
            ResultSet rs = ps.executeQuery(q);
