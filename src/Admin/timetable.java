...
public class timetable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 180, 40));
        ...
        getContentPane().add(noticeName, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 130, 40, -1));
        ...
        getContentPane().add(year, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 530, 160));

        proBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/profBack.jpg"))); // NOI18N
        getContentPane().add(proBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 770, 450));
